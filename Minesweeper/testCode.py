...
# class Slider():
#     def __init__(self, name, win, val, maxi, mini, pos):
#         self.win = win
...
# pen = Slider("Pen", screen, 10, 15, 1, 25)
# freq = Slider("Freq", screen, 1, 3, 0.2, 150)
# jmp = Slider("Jump", screen, 10, 20, 1, 275)
# size = Slider("Size", screen, 200, 200, 20, 400)
# focus = Slider("Focus", screen, 0, 6, 0, 525)
# phase = Slider("Phase", screen, 3.14, 6, 0.3, 650)
# speed = Slider("Speed", screen, 50, 150, 10, 775)
# slides = [pen, freq, jmp, size, focus, phase, speed]

# q = pygame.surface.Surface((100,100))
# print(q.get_rect())
